...
feature "Demo 2", demo_2_feature: true do
  scenario "Main first", first_2_spec: true do
    @page.main.load
  ...
  scenario "Main second", second_2_spec: true do
    @page.dnd.load
  ...
  scenario "Main third", third_2_spec: true do
